...
def generate_launch_description():
    ...
    rover_dir = get_package_share_directory('velathrobotics_driver')
    ...
    rl_launch_path = os.path.join(get_package_share_directory("velathrobotics_driver"), 'launch', 'robot_localizer_outdoor.launch.py')
    ...
    declare_slam_params_file_cmd = DeclareLaunchArgument(
        'slam_params_file',
        default_value=os.path.join(get_package_share_directory("velathrobotics_driver"),
    ...
    map_file_arg = PathJoinSubstitution([
        get_package_share_directory('velathrobotics_driver'), 'maps', map_file])
